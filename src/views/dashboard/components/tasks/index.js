...
const index = memo(
  ({ data, setSendingData, SendingData, ENDPOINT, programmers }) => {
    const [dataToUpdate /* , setdataToUpdate */] = useState(data);

    const [cambiandoEstado, setcambiandoEstado] = useState(false);

    /* Funcion encargada de actualizar el estado de una tarea */
    const updateState = () => {
      setcambiandoEstado(true);
      request(ENDPOINT, UPDATE_STATE, {
        id: data.id,
        culminada: !data.culminada,
      })
        .then((_) => {
    ...
    /* Funcionar encargada de borrar la tarea */
        ...
        <div className="card-body">
          ...
          <div className="status">
            ...
            {cambiandoEstado ? (
              ...
              <div
                className="custom-control custom-switch cabra"
                style={{ cursor: "pointer" }}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <CreateTask
                  editButton={`${data.id}_editButton`}
